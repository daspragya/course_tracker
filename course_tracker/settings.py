...
#         'NAME': 'course_tracker', # Replace with the name of your database
#         'USER': 'postgres', # Replace with the username you created
#         'PASSWORD': '2008', # Replace with the password you created
